...
open_successful='Телефонная книга успещно открыта!'
...
input_edit_word = 'Введите ключивое слово для поиска контакта, который хотите изменить:'
...
confirm_delete_contact = lambda x: f'Вы действительно хотите удалить контакт - {х}? (y/n)'
